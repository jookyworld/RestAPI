...
public class ApiV1PostCommentControllerTest {
    ...
    void t1() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(get("/api/v1/posts/%d/comments/%d".formatted(postId, id)))
                .andDo(print());
    ...
    void t2() throws Exception {
        long postId = 1;
        ResultActions resultActions = mvc
                .perform(get("/api/v1/posts/%d/comments".formatted(postId)))
                .andDo(print());
    ...
    void t4() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.resultCode").value("200-1"))
                .andExpect(jsonPath("$.msg").value("%d번 댓글 수정".formatted(id)));
    }
    ...
    void t5() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.msg").value("%d번 댓글 작성".formatted(postComment.getId())))
